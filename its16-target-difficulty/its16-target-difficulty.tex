...
\begin{frame}
	...
	\only<1>{\includegraphics[width=\textwidth]{img/slepemapy_world_practice}}
	\only<2>{\includegraphics[width=\textwidth]{img/slepemapy_world}}
\end{frame}
...
\begin{frame}
  ...
  \only<1>{\includegraphics[width=\textwidth]{img/error_rate_by_set_order_by_context_1}}
  \only<2>{\includegraphics[width=\textwidth]{img/error_rate_by_set_order_by_context}}
\end{frame}
...
\begin{frame}
  ...
  \only<2>{\includegraphics[width=\textwidth]{img/target_difficulty_attrition_bias_contexts_selected}}
\end{frame}
