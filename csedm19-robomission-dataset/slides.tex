...
%   in which students create programs for a spaceship in space
...
\begin{frame}
  ...
  \item published models and algorithms  % you can read about the used models and algorithms
...
\begin{frame}
  ...
  \item 1.4 million program snapshots  % fine-grained data % (each edit)
  \item 85 tasks
